...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-blue-950 text-white relative">
      ...
      {/* Header */}
      <header className="fixed top-0 left-0 right-0 z-50 bg-blue-900/80 backdrop-blur-md shadow-lg h-16 flex items-center justify-between px-4 lg:px-8 border-b border-white/10">
        <button 
        ...
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-royal-blue rounded-lg flex items-center justify-center shadow-md border border-white/20">
